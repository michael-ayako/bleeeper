...
echo"<div id='error_friend_req_2'><div class='title'><strong>Some other Day!</strong></div><div class='dialogmessage'>You are no longer this user</div><div class='dialogmsgbuttons'><button style='width:130px;height:30px;border-style:none;'onclick='pscreen();return false;'>OK</button></div></div>";
