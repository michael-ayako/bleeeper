...
echo "<div id='success_friend_req_1'><div class='title'><strong>Success!</strong>Joined Group</div><div class='dialogmessage'>You have successfully joined the group.</div><div class='dialogmsgbuttons'><button style='width:130px;height:30px;border-style:none;'onclick='pscreen2();return false;'>OK</button></div></div>";
