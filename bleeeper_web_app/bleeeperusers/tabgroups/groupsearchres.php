...
if($element!=NULL){
$sql="SELECT * FROM group_data_information_tb WHERE group_name LIKE '$element%' AND state='1' ORDER BY DATE_AND_TIME DESC";
...
<strong>Group administrator:</strong><br/>'.$nm.'<br/>
<strong>Started:</strong><br/>'.$date11.'<br/><br/>
</div><div class="area"><strong>About Group:</strong><br/>'.$res["about_group"].'<br/></div>
<input type="button" id="send_grp_req" value="Request to Join Group" onClick="funcgrp_req('.$sid.','.$res["id"].');return false;"/></div>';
