...
echo "<div id='success_friend_req_1'><div class='title'><strong>Success!</strong>Rejected invite</div><div class='dialogmessage'>Your have successfully rejected the group request.</div><div class='dialogmsgbuttons'><button style='width:130px;height:30px;border-style:none;'onclick='pscreen2();return false;'>OK</button></div></div>";
