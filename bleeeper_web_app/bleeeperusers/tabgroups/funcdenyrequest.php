...
echo "<div id='success_friend_req_1'><div class='title'><strong>Success!</strong>Denied Request</div><div class='dialogmessage'>You have successully denied the user form joining your group</div><div class='dialogmsgbuttons'><button style='width:130px;height:30px;border-style:none;'onclick='pscreen2();return false;'>OK</button></div></div>";
